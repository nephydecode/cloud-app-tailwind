        ...
        <div name='about' className='w-full my-32'>
            <div className='max-w-[1240px] mx-auto px-3'>
                <div className='text-center'>
                    ...
                    <p className='text-3xl py-6 text-gray-500'>We help teams unlock unlimited business value by providing the best cloud solutions and providing support to developers.</p>
                </div>
